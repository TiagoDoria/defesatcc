# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-01-23 19:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.EmailField(max_length=254, unique=True, verbose_name='E-mail')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_acesso', models.CharField(choices=[('baixo', 'Baixo'), ('medio', 'Médio'), ('Alto', 'Alto')], default='baixo', max_length=6)),
            ],
            options={
                'verbose_name': 'Perfil',
        ...
        migrations.AddField(
            model_name='usuario',
            name='titulo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='titulo', to='accounts.Titulo', verbose_name='Titulação'),
        ),
        migrations.AddField(
            model_name='usuario',
